...
import { ExceptionConstants } from '@/core/constants/exceptions.constants';
import { ErrorResponse, IException } from '@/core/interfaces/response.interfaces';
...
export class BadRequestException extends HttpException {
     ...
     */
    generateHttpResponseBody = (message?: string): ErrorResponse => {
        return {
            success: false,
            data: null,
